...
--Command     : generate_target SimulationBD_VZ.bd
--Design      : SimulationBD_VZ
...
entity SimulationBD_VZ is
  ...
  attribute CORE_GENERATION_INFO of SimulationBD_VZ : entity is "SimulationBD_VZ,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SimulationBD_VZ,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of SimulationBD_VZ : entity is "SimulationBD_VZ.hwdef";
end SimulationBD_VZ;

architecture STRUCTURE of SimulationBD_VZ is
  component SimulationBD_VZ_circuit_Verzoerung_2_0_0 is
  port (
  ...
  end component SimulationBD_VZ_circuit_Verzoerung_2_0_0;
  component SimulationBD_VZ_circuit_Zaehler_3_0_0 is
  port (
  ...
  end component SimulationBD_VZ_circuit_Zaehler_3_0_0;
  component SimulationBD_VZ_circuit_or_0_0 is
  port (
    sig_in_0 : in STD_LOGIC;
    sig_in_1 : in STD_LOGIC;
    sig_out_0 : out STD_LOGIC
  );
  end component SimulationBD_VZ_circuit_or_0_0;
  component SimulationBD_VZ_Operationswerk_0_0 is
  port (
    clock : in STD_LOGIC;
    INBUS : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  end component SimulationBD_VZ_Operationswerk_0_0;
  component SimulationBD_VZ_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Res : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component SimulationBD_VZ_util_vector_logic_0_0;
  component SimulationBD_VZ_xlconcat_0_0 is
  port (
  ...
  end component SimulationBD_VZ_xlconcat_0_0;
  component SimulationBD_VZ_xlconcat_1_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component SimulationBD_VZ_xlconcat_1_0;
  ...
  signal circuit_Verzoerung_2_0_sig_out_DONE : STD_LOGIC;
  signal circuit_Verzoerung_2_0_sig_out_c1 : STD_LOGIC;
  signal circuit_Verzoerung_2_0_sig_out_c8 : STD_LOGIC;
...
begin
  ...
  Done <= circuit_Verzoerung_2_0_sig_out_DONE;
  ...
  k1_start_1 <= k1_start;
  reset_1 <= reset;
Operationswerk_0: component SimulationBD_VZ_Operationswerk_0_0
     port map (
...
circuit_Verzoerung_2_0: component SimulationBD_VZ_circuit_Verzoerung_2_0_0
     port map (
      sig_in_Takt => clk_1,
      sig_in_k1 => k1_start_1,
      sig_in_k2 => Operationswerk_0_k2,
      sig_in_k3 => circuit_Zaehler_3_0_sig_out_null,
      sig_in_reset => reset_1,
      sig_out_DONE => circuit_Verzoerung_2_0_sig_out_DONE,
      sig_out_c0 => Steuerwerk_Moore_0_c0,
      sig_out_c1 => circuit_Verzoerung_2_0_sig_out_c1,
      sig_out_c10 => Steuerwerk_Moore_0_c10,
      sig_out_c11 => Steuerwerk_Moore_0_c11,
      sig_out_c12 => Steuerwerk_Moore_0_c12,
      sig_out_c2 => Steuerwerk_Moore_0_c2,
      sig_out_c3 => Steuerwerk_Moore_0_c3,
      sig_out_c4 => Steuerwerk_Moore_0_c4,
      sig_out_c5 => Steuerwerk_Moore_0_c5,
      sig_out_c6 => Steuerwerk_Moore_0_c6,
      sig_out_c7 => Steuerwerk_Moore_0_c7,
      sig_out_c8 => circuit_Verzoerung_2_0_sig_out_c8,
      sig_out_c9 => Steuerwerk_Moore_0_c9
    );
circuit_Zaehler_3_0: component SimulationBD_VZ_circuit_Zaehler_3_0_0
     port map (
      sig_in_Reset => circuit_or_0_sig_out_0,
      sig_in_Text => util_vector_logic_0_Res(0),
      sig_in_incCnt => circuit_Verzoerung_2_0_sig_out_c8,
...
circuit_or_0: component SimulationBD_VZ_circuit_or_0_0
     port map (
      sig_in_0 => reset_1,
      sig_in_1 => circuit_Verzoerung_2_0_sig_out_c1,
      sig_out_0 => circuit_or_0_sig_out_0
    );
util_vector_logic_0: component SimulationBD_VZ_util_vector_logic_0_0
     port map (
      Op1(0) => clk_1,
      Res(0) => util_vector_logic_0_Res(0)
    );
xlconcat_0: component SimulationBD_VZ_xlconcat_0_0
     port map (
      In0(0) => Steuerwerk_Moore_0_c0,
      In1(0) => circuit_Verzoerung_2_0_sig_out_c1,
      ...
      In8(0) => circuit_Verzoerung_2_0_sig_out_c8,
      In9(0) => Steuerwerk_Moore_0_c9,
      dout(12 downto 0) => xlconcat_0_dout(12 downto 0)
    );
xlconcat_1: component SimulationBD_VZ_xlconcat_1_0
     port map (
